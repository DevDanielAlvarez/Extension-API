...
namespace App\Filament\Resources\PatientMedicines\RelationManagers;
...
class PatientMedicineMovementsRelationManager extends RelationManager
{
    ...
    {
        return PatientMedicineMovementForm::configure($schema);
    }
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->action(function (array $data): void {
                        try {
                            PatientMedicineMovementForm::create($this->getOwnerRecord()->id, $data);
